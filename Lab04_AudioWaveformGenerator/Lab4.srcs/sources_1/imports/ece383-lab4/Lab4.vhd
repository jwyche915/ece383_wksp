...
begin
    ...
    phase_inc <= x"0222" when btn(0) = '1' else  -- 409.5Hz
                 x"0289" when btn(1) = '1' else  -- 486.8Hz
                 x"0376" when btn(2) = '1' else  -- 664.5Hz
                 x"03B9" when btn(3) = '1' else  -- 714.8Hz
                 x"042E" when btn(4) = '1' else  -- 802.5Hz
                 x"023D";  -- birth day 430Hz
